...
def get_latest_draw_no_fast():
    try:
        ...
        title = soup.select_one('div.win_result h4 strong').text  # ex: "1112회"
...
st.title("🎰 로또 번호 추천기 (빠른 크롤링 버전)")
st.markdown("🌀 원하는 회차 범위로 실시간 분석하여 추천 조합을 생성합니다.")

with st.spinner("최신 회차 불러오는 중..."):
